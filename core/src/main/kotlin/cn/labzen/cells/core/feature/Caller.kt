...
object Caller {
  ...
  @JvmStatic
  @JvmOverloads
  fun get(frameDepth: Int = 1): Detail? {
    ...
    return with(stackTraceElement) { Detail(Class.forName(className), methodName) }
  }
   ...
   */
  data class Detail(val classType: Class<*>, val methodName: String)
