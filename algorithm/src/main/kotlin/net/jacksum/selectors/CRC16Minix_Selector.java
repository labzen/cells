 ...
 * @author johann
 */
public class CRC16Minix_Selector extends Selector {

  private final static String ID = "crc16_minix";
  private final static String DESCRIPTION = "CRC-16 (Minix)";
  private final static String ALIAS = "crc-16_minix";
