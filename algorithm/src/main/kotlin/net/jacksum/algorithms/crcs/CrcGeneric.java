...
public class CrcGeneric extends AbstractChecksum {
   ...
   */
  public CrcGeneric(int width, long poly, long initialValue, boolean refIn, boolean refOut, long xorOut) throws
...
*/
  ...
  private void commonParamsInit(int width, long poly, long initialValue, boolean refIn, boolean refOut, long xorOut) {
    this.bitWidth = width;
    this.poly = poly;
