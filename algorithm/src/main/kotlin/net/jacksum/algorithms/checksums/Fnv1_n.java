...
public class Fnv1_n extends Fnv0_n {
  ...
  public Fnv1_n(String strBitWidth) throws NoSuchAlgorithmException {
    ...
    switch (bitWidth) {
      case 32:
        INIT = new BigInteger("2166136261");
        break;
      case 64:
        INIT = new BigInteger("14695981039346656037");
        break;
      case 128:
        INIT = new BigInteger("144066263297769815596495629667062367629");
        break;
      case 256:
        INIT = new BigInteger("100029257958052580907070968620625704837092796014241193945225284501741471925557");
        break;
      case 512:
        INIT = new BigInteger(
      ...
      case 1024:
        ...
        break;
      default:
        throw new NoSuchAlgorithmException("Unknown algorithm: width " + bitWidth + " is not supported.");
    }
    value = INIT;
  }
